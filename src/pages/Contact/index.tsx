          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <a
                  href="mailto:priyanshuchawda20@gmail.com"
                  className="hover:text-primary transition-colors"
                >
                  priyanshuchawda20@gmail.com
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <svg
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-dark focus:ring-2 focus:ring-primary resize-none"
            />
          </div>
